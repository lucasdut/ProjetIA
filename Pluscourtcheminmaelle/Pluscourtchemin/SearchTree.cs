...
namespace Pluscourtchemin
{
    public class SearchTree
    {
        ...
        public List<List<GenericNode>> L_Ouverts_Historique = new List<List<GenericNode>>();
        public List<List<GenericNode>> L_Fermes_Historique = new List<List<GenericNode>>();
        ...
        public void MAJ()
        {
            if (!L_Ouverts_Historique.Contains(L_Ouverts))
            {
                L_Ouverts_Historique.Add(L_Ouverts);
            }
            else if (!L_Ouverts_Historique.Contains(L_Fermes))
            {
                L_Fermes_Historique.Add(L_Fermes);
            }
        }
